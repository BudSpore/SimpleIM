...
public class Server {  
    ...
    private JTextArea contentArea; //消息显示区 
    private JTextField txt_message;  //发送框
    private JTextField txt_max;//人数上限框  
    ...
    private DefaultListModel listModel; //管理JList数据 
    ...
    public Server() {  
        ...
        southPanel.setBorder(new TitledBorder("输入消息"));  
            ...
            while (true) {
                ...
                try {  
                    ...
                    if (clients.size() == max) {
                        ...
                        //获取socket输入字节流，转换为输入字符流，并将字符流放入缓存里
                        //提供字符的有效读取，
                        
                        PrintWriter w = new PrintWriter(socket  
                                .getOutputStream());  
                      //获取socket输出字节流，并放到文本输出流
                        
                        // 接收客户端的基本用户信息  
                        String inf = r.readLine();  
                        //构建了一个指定的字符串分解器。@分隔标记的分隔符
